import{_ as u,u as b,r,c as _,I as d,o as f,a as v,b as l,t as o,n as s,d as g,e as w,F as x}from"./index-vn6MH7sa.js";async function h({lang:t}){return{...await(async()=>{switch(t.toLowerCase()){case"en":return u(()=>import("./Home-3AqPNgTo.js"),[],import.meta.url);case"sp":return u(()=>import("./Home-BXLqvP8x.js"),[],import.meta.url)}})()}}let p;const B=t=>{Swal.fire({title:t.title,showConfirmButton:!0,showCancelButton:!0,confirmButtonText:t.acp_btn,cancelButtonText:t.ccl_btn,html:`
    <div>
